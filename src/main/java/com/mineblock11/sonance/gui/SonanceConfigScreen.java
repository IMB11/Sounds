...
public class SonanceConfigScreen extends Screen {
    ...
    public SonanceConfigScreen(@Nullable Screen parent) {
        super(Text.translatable("sonance.config.title"));
        this.parent = parent;
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.client.textRenderer, Text.translatable("sonance.config.title"), this.width / 2, 10, 0xFFFFFF);
    }
    ...
    protected void init() {
        ...
        this.openUIButton = new ImageButtonWidget(0, 0, 0, 0, Text.translatable("sonance.config.ui"), new Identifier("sonance", "textures/gui/ui_sounds.webp"));
        this.openGameplayButton = new ImageButtonWidget(0, 0, 0, 0, Text.translatable("sonance.config.gameplay"), new Identifier("sonance", "textures/gui/gameplay_sounds.webp"));
        this.openModButton = new ImageButtonWidget(0, 0, 0, 0, Text.translatable("sonance.config.mod"), new Identifier("sonance", "textures/gui/mod_sounds.webp"));
