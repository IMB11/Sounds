...
public class DynamicTagPairs extends TagPairProvider {
    ...
    public void accept(BiConsumer<String, TagPair.Builder> provider) {
        provider.accept("acacia_leaves", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_ACACIA_LEAVES_BREAK, CustomSounds.BLOCK_ACACIA_LEAVES_STEP, CustomSounds.BLOCK_ACACIA_LEAVES_PLACE, CustomSounds.BLOCK_ACACIA_LEAVES_HIT, CustomSounds.BLOCK_ACACIA_LEAVES_FALL));

        provider.accept("acacia_log", TagPair.Builder.create()
                .addKey(Blocks.ACACIA_LOG)
                .addKey(Blocks.ACACIA_WOOD)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_ACACIA_LOG_BREAK, CustomSounds.BLOCK_ACACIA_LOG_STEP, CustomSounds.BLOCK_ACACIA_LOG_PLACE, CustomSounds.BLOCK_ACACIA_LOG_HIT, CustomSounds.BLOCK_ACACIA_LOG_FALL));
        ...
        provider.accept("acacia_object", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_ACACIA_PLANKS_BREAK, CustomSounds.BLOCK_ACACIA_PLANKS_STEP, CustomSounds.BLOCK_ACACIA_PLANKS_PLACE, CustomSounds.BLOCK_ACACIA_PLANKS_HIT, CustomSounds.BLOCK_ACACIA_PLANKS_FALL));
        ...
        provider.accept("barrel", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, SoundEvents.BLOCK_WOOD_BREAK, CustomSounds.BLOCK_BARREL_STEP, CustomSounds.BLOCK_BARREL_PLACE, CustomSounds.BLOCK_BARREL_HIT, SoundEvents.BLOCK_WOOD_FALL));

        provider.accept("beehive", TagPair.Builder.create()
                .addKey(Blocks.BEEHIVE)
                .group(1.5F, 1.0F, CustomSounds.BLOCK_BEEHIVE_BREAK, CustomSounds.BLOCK_BOOKSHELF_STEP, CustomSounds.BLOCK_BEEHIVE_PLACE, CustomSounds.BLOCK_BEEHIVE_HIT, SoundEvents.BLOCK_WOOD_FALL));

        provider.accept("birch_leaves", TagPair.Builder.create()
                .addKey(Blocks.BIRCH_LEAVES)
                .addKey(Blocks.BIRCH_SAPLING)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_BIRCH_LEAVES_BREAK, CustomSounds.BLOCK_BIRCH_LEAVES_STEP, CustomSounds.BLOCK_BIRCH_LEAVES_PLACE, CustomSounds.BLOCK_BIRCH_LEAVES_HIT, CustomSounds.BLOCK_BIRCH_LEAVES_FALL));
        ...
        provider.accept("birch_log", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_BIRCH_LOG_BREAK, CustomSounds.BLOCK_BIRCH_LOG_STEP, CustomSounds.BLOCK_BIRCH_LOG_PLACE, CustomSounds.BLOCK_BIRCH_LOG_HIT, CustomSounds.BLOCK_BIRCH_LOG_FALL));
        ...
        provider.accept("birch_object", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_BIRCH_OBJECT_BREAK, CustomSounds.BLOCK_BIRCH_OBJECT_STEP, CustomSounds.BLOCK_BIRCH_OBJECT_PLACE, CustomSounds.BLOCK_BIRCH_PLANKS_HIT, CustomSounds.BLOCK_BIRCH_OBJECT_FALL));
        ...
        provider.accept("birch_planks", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_BIRCH_PLANKS_BREAK, CustomSounds.BLOCK_BIRCH_PLANKS_STEP, CustomSounds.BLOCK_BIRCH_PLANKS_PLACE, CustomSounds.BLOCK_BIRCH_PLANKS_HIT, CustomSounds.BLOCK_BIRCH_PLANKS_FALL));

        provider.accept("bookshelf", TagPair.Builder.create()
                .addKey(Blocks.BOOKSHELF)
                .group(1.5F, 1.0F, CustomSounds.BLOCK_BOOKSHELF_BREAK, CustomSounds.BLOCK_BOOKSHELF_STEP, CustomSounds.BLOCK_BOOKSHELF_PLACE, CustomSounds.BLOCK_BOOKSHELF_HIT, SoundEvents.BLOCK_WOOD_FALL));

        provider.accept("chest", TagPair.Builder.create()
                .addKey(Blocks.CHEST)
                .group(1.5F, 1.0F, SoundEvents.BLOCK_WOOD_BREAK, CustomSounds.BLOCK_CHEST_STEP, CustomSounds.BLOCK_BARREL_PLACE, CustomSounds.BLOCK_CHEST_HIT, SoundEvents.BLOCK_WOOD_FALL));

        provider.accept("clay", TagPair.Builder.create()
                .addKey(Blocks.CLAY)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_CLAY_BREAK, CustomSounds.BLOCK_CLAY_STEP, CustomSounds.BLOCK_CLAY_PLACE, CustomSounds.BLOCK_CLAY_HIT, SoundEvents.BLOCK_MUD_FALL));
        ...
        provider.accept("cobblestone", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_COBBLESTONE_BREAK, CustomSounds.BLOCK_COBBLESTONE_STEP, CustomSounds.BLOCK_COBBLESTONE_PLACE, CustomSounds.BLOCK_COBBLESTONE_HIT, CustomSounds.BLOCK_COBBLESTONE_FALL));

        provider.accept("copper_ore", TagPair.Builder.create()
                .addKey(Blocks.COPPER_ORE)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_COPPER_ORE_BREAK, CustomSounds.BLOCK_COPPER_ORE_STEP, CustomSounds.BLOCK_COPPER_ORE_PLACE, CustomSounds.BLOCK_COPPER_ORE_HIT, CustomSounds.BLOCK_COPPER_ORE_FALL));
        ...
        provider.accept("deepslate_copper_ore", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_COPPER_ORE_BREAK, CustomSounds.BLOCK_DEEPSLATE_COPPER_ORE_STEP, CustomSounds.BLOCK_DEEPSLATE_COPPER_ORE_PLACE, CustomSounds.BLOCK_DEEPSLATE_COPPER_ORE_HIT, CustomSounds.BLOCK_DEEPSLATE_COPPER_ORE_FALL));

        provider.accept("deepslate_gold_ore", TagPair.Builder.create()
                .addKey(Blocks.DEEPSLATE_GOLD_ORE)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_DEEPSLATE_GOLD_ORE_BREAK, CustomSounds.BLOCK_DEEPSLATE_GOLD_ORE_STEP, CustomSounds.BLOCK_DEEPSLATE_GOLD_ORE_PLACE, CustomSounds.BLOCK_DEEPSLATE_GOLD_ORE_HIT, CustomSounds.BLOCK_DEEPSLATE_GOLD_ORE_FALL));

        provider.accept("deepslate_iron_ore", TagPair.Builder.create()
                .addKey(Blocks.DEEPSLATE_IRON_ORE)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_DEEPSLATE_IRON_ORE_BREAK, CustomSounds.BLOCK_DEEPSLATE_IRON_ORE_STEP, CustomSounds.BLOCK_DEEPSLATE_IRON_ORE_PLACE, CustomSounds.BLOCK_DEEPSLATE_IRON_ORE_HIT, CustomSounds.BLOCK_DEEPSLATE_IRON_ORE_FALL));

        provider.accept("emerald_block", TagPair.Builder.create()
                .addKey(Blocks.EMERALD_BLOCK)
                .group(1.0F, 1.2F, SoundEvents.BLOCK_BONE_BLOCK_BREAK, SoundEvents.BLOCK_BONE_BLOCK_STEP, CustomSounds.BLOCK_QUARTZ_PLACE, SoundEvents.BLOCK_BONE_BLOCK_HIT, SoundEvents.BLOCK_BONE_BLOCK_FALL));

        provider.accept("end_stone", TagPair.Builder.create()
                .addKey(Blocks.END_STONE)
                .group(0.9F, 0.8F, CustomSounds.BLOCK_QUARTZ_BREAK, CustomSounds.BLOCK_QUARTZ_STEP, CustomSounds.BLOCK_QUARTZ_PLACE, SoundEvents.BLOCK_STONE_HIT, SoundEvents.BLOCK_STONE_FALL));
        ...
        provider.accept("end_stone_bricks", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, SoundEvents.BLOCK_DEEPSLATE_BRICKS_BREAK, CustomSounds.BLOCK_QUARTZ_STEP, SoundEvents.BLOCK_DEEPSLATE_BRICKS_PLACE, SoundEvents.BLOCK_DEEPSLATE_BRICKS_HIT, SoundEvents.BLOCK_DEEPSLATE_BRICKS_FALL));
        ...
        provider.accept("glass", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_GLASS_BREAK, CustomSounds.BLOCK_GLASS_STEP, CustomSounds.BLOCK_GLASS_PLACE, SoundEvents.BLOCK_GLASS_HIT, SoundEvents.BLOCK_GLASS_FALL));

        provider.accept("gold", TagPair.Builder.create()
                .addKey(Blocks.GOLD_BLOCK)
                .addKey(Blocks.LIGHT_WEIGHTED_PRESSURE_PLATE)
                .group(1.0F, 1.6F, SoundEvents.BLOCK_NETHERITE_BLOCK_BREAK, CustomSounds.BLOCK_GOLD_BLOCK_STEP, SoundEvents.BLOCK_NETHERITE_BLOCK_PLACE, SoundEvents.BLOCK_NETHERITE_BLOCK_HIT, SoundEvents.BLOCK_NETHERITE_BLOCK_FALL));

        provider.accept("gold_ore", TagPair.Builder.create()
                .addKey(Blocks.GOLD_ORE)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_GOLD_ORE_BREAK, CustomSounds.BLOCK_GOLD_ORE_STEP, CustomSounds.BLOCK_GOLD_ORE_PLACE, CustomSounds.BLOCK_GOLD_ORE_HIT, CustomSounds.BLOCK_GOLD_ORE_FALL));

        provider.accept("gravel", TagPair.Builder.create()
                .addKey(Blocks.GRAVEL)
                .group(1.0F, 1.2F, CustomSounds.BLOCK_GRAVEL_BREAK, CustomSounds.BLOCK_GRAVEL_STEP, CustomSounds.BLOCK_GRAVEL_PLACE, CustomSounds.BLOCK_GRAVEL_HIT, SoundEvents.BLOCK_GRAVEL_FALL));

        provider.accept("hay_block", TagPair.Builder.create()
                .addKey(Blocks.HAY_BLOCK)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_HAY_BLOCK_BREAK, CustomSounds.BLOCK_HAY_BLOCK_STEP, CustomSounds.BLOCK_HAY_BLOCK_PLACE, CustomSounds.BLOCK_HAY_BLOCK_HIT, SoundEvents.BLOCK_TUFF_FALL));

        provider.accept("ice", TagPair.Builder.create()
                .addKey(Blocks.ICE)
                .addKey(Blocks.FROSTED_ICE)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_ICE_BREAK, CustomSounds.BLOCK_ICE_STEP, CustomSounds.BLOCK_ICE_PLACE, CustomSounds.BLOCK_ICE_HIT, CustomSounds.BLOCK_ICE_FALL));
        ...
        provider.accept("iron", TagPair.Builder.create()
                ...
                .group(1.0F, 1.2F, SoundEvents.BLOCK_NETHERITE_BLOCK_BREAK, CustomSounds.BLOCK_IRON_BLOCK_STEP, SoundEvents.BLOCK_NETHERITE_BLOCK_PLACE, SoundEvents.BLOCK_NETHERITE_BLOCK_HIT, SoundEvents.BLOCK_NETHERITE_BLOCK_FALL));

        provider.accept("iron_ore", TagPair.Builder.create()
                .addKey(Blocks.IRON_ORE)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_DEEPSLATE_IRON_ORE_BREAK, CustomSounds.BLOCK_IRON_ORE_STEP, CustomSounds.BLOCK_IRON_ORE_PLACE, CustomSounds.BLOCK_IRON_ORE_HIT, CustomSounds.BLOCK_IRON_ORE_FALL));

        provider.accept("jungle_leaves", TagPair.Builder.create()
                .addKey(Blocks.JUNGLE_LEAVES)
                .addKey(Blocks.JUNGLE_SAPLING)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_JUNGLE_LEAVES_BREAK, CustomSounds.BLOCK_JUNGLE_LEAVES_STEP, CustomSounds.BLOCK_JUNGLE_LEAVES_PLACE, CustomSounds.BLOCK_JUNGLE_LEAVES_HIT, CustomSounds.BLOCK_JUNGLE_LEAVES_FALL));
        ...
        provider.accept("jungle_object", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_JUNGLE_PLANKS_BREAK, CustomSounds.BLOCK_JUNGLE_PLANKS_STEP, CustomSounds.BLOCK_JUNGLE_PLANKS_PLACE, CustomSounds.BLOCK_SPRUCE_PLANKS_HIT, CustomSounds.BLOCK_JUNGLE_PLANKS_FALL));
        ...
        provider.accept("loom", TagPair.Builder.create()
                .addKey(Blocks.LOOM)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_LOOM_BREAK, CustomSounds.BLOCK_LOOM_STEP, CustomSounds.BLOCK_LOOM_PLACE, CustomSounds.BLOCK_LOOM_HIT, SoundEvents.BLOCK_WOOD_FALL));

        provider.accept("magma_block", TagPair.Builder.create()
                .addKey(Blocks.MAGMA_BLOCK)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_MAGMA_BLOCK_BREAK, CustomSounds.BLOCK_MAGMA_BLOCK_STEP, CustomSounds.BLOCK_MAGMA_BLOCK_PLACE, CustomSounds.BLOCK_MAGMA_BLOCK_HIT, CustomSounds.BLOCK_MAGMA_BLOCK_FALL));

        provider.accept("mangrove_leaves", TagPair.Builder.create()
                .addKey(Blocks.MANGROVE_LEAVES)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_MANGROVE_LEAVES_BREAK, CustomSounds.BLOCK_MANGROVE_LEAVES_STEP, CustomSounds.BLOCK_MANGROVE_LEAVES_PLACE, CustomSounds.BLOCK_MANGROVE_LEAVES_HIT, CustomSounds.BLOCK_MANGROVE_LEAVES_FALL));

        provider.accept("mangrove_log", TagPair.Builder.create()
                .addKey(Blocks.MANGROVE_LOG)
                .addKey(Blocks.MANGROVE_WOOD)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_MANGROVE_LOG_BREAK, CustomSounds.BLOCK_MANGROVE_LOG_STEP, CustomSounds.BLOCK_MANGROVE_LOG_PLACE, CustomSounds.BLOCK_MANGROVE_LOG_HIT, CustomSounds.BLOCK_MANGROVE_LOG_FALL));
        ...
        provider.accept("mangrove_object", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_MANGROVE_PLANKS_BREAK, CustomSounds.BLOCK_MANGROVE_PLANKS_STEP, CustomSounds.BLOCK_MANGROVE_PLANKS_PLACE, CustomSounds.BLOCK_MANGROVE_PLANKS_HIT, CustomSounds.BLOCK_MANGROVE_PLANKS_FALL));
        ...
        provider.accept("mossy_cobblestone", TagPair.Builder.create()
                ...
                .addKey(Blocks.MOSSY_COBBLESTONE_STAIRS)
                .addKey(Blocks.MOSSY_COBBLESTONE_WALL)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_MOSSY_COBBLESTONE_BREAK, CustomSounds.BLOCK_MOSSY_COBBLESTONE_STEP, CustomSounds.BLOCK_COBBLESTONE_PLACE, CustomSounds.BLOCK_MOSSY_COBBLESTONE_HIT, CustomSounds.BLOCK_COBBLESTONE_FALL));
        ...
        provider.accept("mossy_stone_bricks", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_MOSSY_COBBLESTONE_BREAK, CustomSounds.BLOCK_MOSSY_STONE_BRICKS_STEP, SoundEvents.BLOCK_DEEPSLATE_BRICKS_PLACE, CustomSounds.BLOCK_MOSSY_STONE_BRICKS_HIT, CustomSounds.BLOCK_MOSSY_STONE_BRICKS_FALL));
        ...
        provider.accept("oak_log", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_OAK_LOG_BREAK, CustomSounds.BLOCK_OAK_LOG_STEP, CustomSounds.BLOCK_OAK_LOG_PLACE, CustomSounds.BLOCK_OAK_LOG_HIT, CustomSounds.BLOCK_OAK_LOG_FALL));
        ...
        provider.accept("packed_ice", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_PACKED_ICE_BREAK, CustomSounds.BLOCK_PACKED_ICE_STEP, CustomSounds.BLOCK_PACKED_ICE_PLACE, CustomSounds.BLOCK_PACKED_ICE_HIT, CustomSounds.BLOCK_PACKED_ICE_FALL));
        ...
        provider.accept("quartz", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_QUARTZ_BREAK, CustomSounds.BLOCK_QUARTZ_STEP, SoundEvents.BLOCK_DEEPSLATE_PLACE, SoundEvents.BLOCK_STONE_HIT, SoundEvents.BLOCK_DEEPSLATE_FALL));

        provider.accept("raw_gold_block", TagPair.Builder.create()
                .addKey(Blocks.RAW_GOLD_BLOCK)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_RAW_GOLD_BLOCK_BREAK, CustomSounds.BLOCK_RAW_GOLD_BLOCK_STEP, CustomSounds.BLOCK_RAW_GOLD_BLOCK_PLACE, CustomSounds.BLOCK_RAW_GOLD_BLOCK_HIT, CustomSounds.BLOCK_RAW_GOLD_BLOCK_FALL));
        ...
        provider.accept("sandstone", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, SoundEvents.BLOCK_TUFF_BREAK, CustomSounds.BLOCK_SANDSTONE_STEP, SoundEvents.BLOCK_TUFF_PLACE, SoundEvents.BLOCK_TUFF_HIT, SoundEvents.BLOCK_TUFF_FALL));
        ...
        provider.accept("sheet_metal", TagPair.Builder.create()
                ...
                .group(1.0F, 1.2F, CustomSounds.BLOCK_SHEET_METAL_BREAK, CustomSounds.BLOCK_SHEET_METAL_STEP, SoundEvents.BLOCK_NETHERITE_BLOCK_PLACE, SoundEvents.BLOCK_NETHERITE_BLOCK_HIT, SoundEvents.BLOCK_NETHERITE_BLOCK_FALL));

        provider.accept("spruce_leaves", TagPair.Builder.create()
                .addKey(Blocks.SPRUCE_LEAVES)
                .addKey(Blocks.SPRUCE_SAPLING)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_SPRUCE_LEAVES_BREAK, CustomSounds.BLOCK_SPRUCE_LEAVES_STEP, CustomSounds.BLOCK_SPRUCE_LEAVES_PLACE, CustomSounds.BLOCK_SPRUCE_LEAVES_HIT, CustomSounds.BLOCK_SPRUCE_LEAVES_FALL));

        provider.accept("spruce_log", TagPair.Builder.create()
                .addKey(Blocks.SPRUCE_LOG)
                .addKey(Blocks.SPRUCE_WOOD)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_SPRUCE_LOG_BREAK, CustomSounds.BLOCK_SPRUCE_LOG_STEP, CustomSounds.BLOCK_SPRUCE_LOG_PLACE, CustomSounds.BLOCK_SPRUCE_LOG_HIT, CustomSounds.BLOCK_SPRUCE_LOG_FALL));
        ...
        provider.accept("spruce_object", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_SPRUCE_OBJECT_BREAK, CustomSounds.BLOCK_SPRUCE_PLANKS_STEP, CustomSounds.BLOCK_SPRUCE_OBJECT_PLACE, CustomSounds.BLOCK_SPRUCE_PLANKS_HIT, CustomSounds.BLOCK_SPRUCE_PLANKS_FALL));
        ...
        provider.accept("spruce_planks", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_SPRUCE_PLANKS_BREAK, CustomSounds.BLOCK_SPRUCE_PLANKS_STEP, CustomSounds.BLOCK_SPRUCE_PLANKS_PLACE, CustomSounds.BLOCK_SPRUCE_PLANKS_HIT, CustomSounds.BLOCK_SPRUCE_PLANKS_FALL));
        ...
        provider.accept("stone_bricks", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_COBBLESTONE_BREAK, CustomSounds.BLOCK_STONE_BRICKS_STEP, SoundEvents.BLOCK_DEEPSLATE_BRICKS_PLACE, CustomSounds.BLOCK_STONE_BRICKS_HIT, CustomSounds.BLOCK_STONE_BRICKS_FALL));
