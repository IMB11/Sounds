...
public class DynamicTagPairs extends TagPairProvider {
    ...
    public void accept(BiConsumer<String, TagPair.Builder> provider) {
        ...
        provider.accept("barrel", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, SoundEvents.WOOD_BREAK, CustomSounds.BLOCK_BARREL_STEP, CustomSounds.BLOCK_BARREL_PLACE, CustomSounds.BLOCK_BARREL_HIT, SoundEvents.WOOD_FALL));

        provider.accept("beehive", TagPair.Builder.create()
                .addKey(Blocks.BEEHIVE)
                .group(1.5F, 1.0F, CustomSounds.BLOCK_BEEHIVE_BREAK, CustomSounds.BLOCK_BOOKSHELF_STEP, CustomSounds.BLOCK_BEEHIVE_PLACE, CustomSounds.BLOCK_BEEHIVE_HIT, SoundEvents.WOOD_FALL));
        ...
        provider.accept("bookshelf", TagPair.Builder.create()
                ...
                .group(1.5F, 1.0F, CustomSounds.BLOCK_BOOKSHELF_BREAK, CustomSounds.BLOCK_BOOKSHELF_STEP, CustomSounds.BLOCK_BOOKSHELF_PLACE, CustomSounds.BLOCK_BOOKSHELF_HIT, SoundEvents.WOOD_FALL));

        provider.accept("chest", TagPair.Builder.create()
                .addKey(Blocks.CHEST)
                .group(1.5F, 1.0F, SoundEvents.WOOD_BREAK, CustomSounds.BLOCK_CHEST_STEP, CustomSounds.BLOCK_BARREL_PLACE, CustomSounds.BLOCK_CHEST_HIT, SoundEvents.WOOD_FALL));

        provider.accept("clay", TagPair.Builder.create()
                .addKey(Blocks.CLAY)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_CLAY_BREAK, CustomSounds.BLOCK_CLAY_STEP, CustomSounds.BLOCK_CLAY_PLACE, CustomSounds.BLOCK_CLAY_HIT, SoundEvents.MUD_FALL));
        ...
        provider.accept("emerald_block", TagPair.Builder.create()
                ...
                .group(1.0F, 1.2F, SoundEvents.BONE_BLOCK_BREAK, SoundEvents.BONE_BLOCK_STEP, CustomSounds.BLOCK_QUARTZ_PLACE, SoundEvents.BONE_BLOCK_HIT, SoundEvents.BONE_BLOCK_FALL));

        provider.accept("end_stone", TagPair.Builder.create()
                .addKey(Blocks.END_STONE)
                .group(0.9F, 0.8F, CustomSounds.BLOCK_QUARTZ_BREAK, CustomSounds.BLOCK_QUARTZ_STEP, CustomSounds.BLOCK_QUARTZ_PLACE, SoundEvents.STONE_HIT, SoundEvents.STONE_FALL));
        ...
        provider.accept("end_stone_bricks", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, SoundEvents.DEEPSLATE_BRICKS_BREAK, CustomSounds.BLOCK_QUARTZ_STEP, SoundEvents.DEEPSLATE_BRICKS_PLACE, SoundEvents.DEEPSLATE_BRICKS_HIT, SoundEvents.DEEPSLATE_BRICKS_FALL));
        ...
        var glass = TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_GLASS_BREAK, CustomSounds.BLOCK_GLASS_STEP, CustomSounds.BLOCK_GLASS_PLACE, SoundEvents.GLASS_HIT, SoundEvents.GLASS_FALL);
        ...
        provider.accept("gold", TagPair.Builder.create()
                ...
                .group(1.0F, 1.6F, SoundEvents.NETHERITE_BLOCK_BREAK, CustomSounds.BLOCK_GOLD_BLOCK_STEP, SoundEvents.NETHERITE_BLOCK_PLACE, SoundEvents.NETHERITE_BLOCK_HIT, SoundEvents.NETHERITE_BLOCK_FALL));
        ...
        provider.accept("gravel", TagPair.Builder.create()
                ...
                .group(1.0F, 1.2F, CustomSounds.BLOCK_GRAVEL_BREAK, CustomSounds.BLOCK_GRAVEL_STEP, CustomSounds.BLOCK_GRAVEL_PLACE, CustomSounds.BLOCK_GRAVEL_HIT, SoundEvents.GRAVEL_FALL));

        provider.accept("hay_block", TagPair.Builder.create()
                .addKey(Blocks.HAY_BLOCK)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_HAY_BLOCK_BREAK, CustomSounds.BLOCK_HAY_BLOCK_STEP, CustomSounds.BLOCK_HAY_BLOCK_PLACE, CustomSounds.BLOCK_HAY_BLOCK_HIT, SoundEvents.TUFF_FALL));
        ...
        provider.accept("iron", TagPair.Builder.create()
                ...
                .group(1.0F, 1.2F, SoundEvents.NETHERITE_BLOCK_BREAK, CustomSounds.BLOCK_IRON_BLOCK_STEP, SoundEvents.NETHERITE_BLOCK_PLACE, SoundEvents.NETHERITE_BLOCK_HIT, SoundEvents.NETHERITE_BLOCK_FALL));
        ...
        provider.accept("loom", TagPair.Builder.create()
                .addKey(Blocks.LOOM)
                .group(1.0F, 1.0F, CustomSounds.BLOCK_LOOM_BREAK, CustomSounds.BLOCK_LOOM_STEP, CustomSounds.BLOCK_LOOM_PLACE, CustomSounds.BLOCK_LOOM_HIT, SoundEvents.WOOD_FALL));
        ...
        provider.accept("mossy_stone_bricks", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_MOSSY_COBBLESTONE_BREAK, CustomSounds.BLOCK_MOSSY_STONE_BRICKS_STEP, SoundEvents.DEEPSLATE_BRICKS_PLACE, CustomSounds.BLOCK_MOSSY_STONE_BRICKS_HIT, CustomSounds.BLOCK_MOSSY_STONE_BRICKS_FALL));
        ...
        provider.accept("quartz", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, CustomSounds.BLOCK_QUARTZ_BREAK, CustomSounds.BLOCK_QUARTZ_STEP, SoundEvents.DEEPSLATE_PLACE, SoundEvents.STONE_HIT, SoundEvents.DEEPSLATE_FALL));
        ...
        provider.accept("sandstone", TagPair.Builder.create()
                ...
                .group(1.0F, 1.0F, SoundEvents.TUFF_BREAK, CustomSounds.BLOCK_SANDSTONE_STEP, SoundEvents.TUFF_PLACE, SoundEvents.TUFF_HIT, SoundEvents.TUFF_FALL));
        ...
        provider.accept("sheet_metal", TagPair.Builder.create()
                ...
                .group(1.0F, 1.2F, CustomSounds.BLOCK_SHEET_METAL_BREAK, CustomSounds.BLOCK_SHEET_METAL_STEP, SoundEvents.NETHERITE_BLOCK_PLACE, SoundEvents.NETHERITE_BLOCK_HIT, SoundEvents.NETHERITE_BLOCK_FALL));
